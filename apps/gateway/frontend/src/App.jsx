...
const handleOcrExtract = async () => {
  ...
  try {
    ...
    setOcrExtractedText(extractedText || extractedIngredients.join(", "));
    ...
    >
      ...
      {(ocrExtractedText || ocrExtractedIngredients.length > 0) && (
        <div style={{ marginTop: "26px" }}>
          <h3 style={{ color: "#2F2A45", marginBottom: "8px" }}>
          ...
          <textarea
            value={ocrExtractedText || ocrExtractedIngredients.join(", ")}
